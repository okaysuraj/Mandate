    ...
    <AppLayout>
      <div className="space-y-lg">
        <div>
          ...
          <h1 className="font-headline-lg text-headline-lg text-primary">Risk Register</h1>
        </div>
        <div className="bg-surface-container-lowest border border-outline-variant p-lg">
          <div className="space-y-sm">
            {['Supplier delay risk', 'Mitigation plan active', 'Resourcing risk monitored'].map((item) => (
