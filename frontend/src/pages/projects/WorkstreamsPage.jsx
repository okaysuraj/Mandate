...
const WorkstreamsPage = () => {
  return (
    <AppLayout>
      <div className="space-y-lg">
        <div>
          <p className="font-label-caps text-label-caps text-on-surface-variant uppercase">Delivery Layer</p>
          <h1 className="font-headline-lg text-headline-lg text-primary">Workstreams</h1>
        </div>
        <div className="bg-surface-container-lowest border border-outline-variant p-lg">
          <div className="space-y-sm">
            {['Product delivery', 'Customer onboarding', 'Operational readiness'].map((item) => (
